# 讨论区编写指南
你可以在这里讨论数学问题，支持 Latex！在创作前请耐心仔细读完如下指南。另外，几分钟读懂 [Markdown 基本语法](https://www.markdown.xyz/basic-syntax/#overview). 特别注意的是，在复制你的 latex 代码过来的时候，请用段落（Paragraphs），否则复制过来的 latex 代码来乱。
